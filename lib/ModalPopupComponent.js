...
class InnerModalComponent extends react_1.default.Component {
    render() {
        ...
        return R("div", { style: rootStyle, className: "modal show" }, R("style", null, "body { overflow-y: hidden }"), R("div", { style: overlayStyle, onClick: this.props.onClose }), R("div", { className: dialogClass, style: dialogStyle }, R("div", { className: "modal-content" }, this.props.header
            ? R("div", { className: "modal-header" }, R("h5", { className: "modal-title" }, this.props.header), this.props.showCloseX
            ...
            ? R("button", { className: "btn-close", onClick: this.props.onClose, style: { position: "absolute", right: 10, top: 10 } })
            : undefined)));
    }
}
