...
module.exports = ModalPopupComponent = (function(superClass) {
  ...
  ModalPopupComponent.propTypes = {
    ...
    scrollDisabled: React.PropTypes.bool
  };
...
ModalComponentContent = (function(superClass) {
  ...
  ModalComponentContent.prototype.calculateModalBodyHeight = function() {
    var content, footer, header, maxHeight, scale;
    header = $(this.refs.modalHeader);
    footer = $(this.refs.modalFooter);
    content = $(this.refs.modalBody);
    if ($(window).height() < $(content).height() && !this.props.scrollDisabled) {
      scale = toPX("vh");
  ...
  ModalComponentContent.prototype.render = function() {
    var style;
    style = !this.props.scrollDisabled ? {} : {};
    return H.div({
    ...
    }, this.props.header)) : this.props.showCloseX ? H.button({
      className: "close",
      style: {
        position: "absolute",
        right: 10,
