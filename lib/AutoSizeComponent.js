var AutoSizeComponent, H, React, ReactDOM, elementResizeDetectorMaker,
...
module.exports = AutoSizeComponent = (function(superClass) {
  ...
  AutoSizeComponent.prototype.componentDidMount = function() {
    ...
    this.resizeDetector.listenTo(ReactDOM.findDOMNode(this), this.updateSize);
    return this.updateSize();
  };

  AutoSizeComponent.prototype.componentWillUnmount = function() {
    this.resizeDetector.removeListener(ReactDOM.findDOMNode(this), this.updateSize);
