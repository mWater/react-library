var Divider, H, Pane, PropTypes, React, ReactDOM, SplitPane,
...
module.exports = SplitPane = (function(superClass) {
  ...
  function SplitPane() {
    ...
    SplitPane.__super__.constructor.apply(this, arguments);
    this.state = {
      resizing: false,
  ...
  SplitPane.prototype.onMouseMove = function(event) {
    ...
    if (this.state.resizing) {
      if (this.props.split === "vertical") {
        firstPaneSize = ReactDOM.findDOMNode(this.refs.firstPane).offsetWidth;
        currentPosition = event.clientX;
      } else {
        firstPaneSize = ReactDOM.findDOMNode(this.refs.firstPane).offsetHeight;
