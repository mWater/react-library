...
function GanttChartDemo() {
    return react_1.default.createElement("div", { style: { paddingTop: 20 } },
        react_1.default.createElement(GanttChart_1.GanttChart, { rows: [
            ...
            ], startDate: "2020-01-01", endDate: "2022-10-01", T: ez_localize_1.defaultT, onMoveRowDown: function () { }, onMoveRowUp: function () { }, onMoveRowLeft: function () { }, onMoveRowRight: function () { }, onRowClick: function () { alert("onRowClick"); }, onAddRow: function () { alert("sdfasdf"); }, onInsertRowAbove: function () { }, onInsertRowBelow: function () { } }));
}
