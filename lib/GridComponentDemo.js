...
const Editor = (props) => {
    ...
    return react_1.default.createElement("div", { style: { width: props.width } },
        react_1.default.createElement(react_select_1.default, { options: [{ value: "x", label: "X" }, { value: "y", label: "Y" }], value: value, onChange: (v) => {
                console.log("onChange");
                setValue(v);
            }, onBlur: () => { console.log("onBlur"); }, isMulti: true, ref: selectRef }));
};
