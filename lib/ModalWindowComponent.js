...
module.exports = ModalWindowComponent = function () {
  var ModalWindowComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ModalWindowComponent, _React$Component);

    var _super = _createSuper(ModalWindowComponent);

    function ModalWindowComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, ModalWindowComponent);
      _this = _super.call(this, props); // Add special region to body
      ...
      if (document.fullscreenElement) {
        document.fullscreenElement.appendChild(_this.modalNode);
      } else {
...
InnerModalComponent = function () {
  ...
  var InnerModalComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(InnerModalComponent, _React$Component2);

    var _super2 = _createSuper(InnerModalComponent);
