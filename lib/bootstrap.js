...
class Button extends react_1.default.Component {
    render() {
        ...
        return R("button", {
            type: "button",
            className: classnames_1.default("btn", `btn-${type}`, { active: this.props.active }, { [`btn-${size}`]: this.props.size != null }),
...
class Checkbox extends react_1.default.Component {
    ...
    render() {
        if (this.props.inline) {
            return R("label", { className: "form-check form-check-inline" }, R("input", {
                type: "checkbox",
                id: this.id,
                disabled: this.props.disabled,
...
class Select extends react_1.default.Component {
    ...
    render() {
        ...
        return R("select", {
            ...
            className: classnames_1.default("form-select", { "form-select-sm": this.props.size === "sm" }, { "form-select-lg": this.props.size === "lg" }),
...
class TextInput extends react_1.default.Component {
    ...
    render() {
        return R("input", {
            ...
            type: "text",
            className: classnames_1.default("form-control", { "form-control-sm": this.props.size === "sm" }, { "form-control-lg": this.props.size === "lg" }),
