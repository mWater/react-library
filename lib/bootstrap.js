var Button, Checkbox, CollapsibleSection, FormGroup, H, Icon, NavPills, NumberInput, PropTypes, R, Radio, React, Select, TextInput, Toggle, classnames,
...
exports.Toggle = Toggle = (function(superClass) {
  ...
  Toggle.prototype.renderOption = function(option, index) {
    if (this.props.value === option.value) {
      ...
      return H.button({
        ...
        onClick: (this.props.onChange ? this.props.onChange.bind(null, option.value) : null)
      }, option.label);
    }
  };
  ...
  Toggle.prototype.render = function() {
    return H.div({
      className: "btn-group " + (this.props.size ? "btn-" + this.props.size : "")
