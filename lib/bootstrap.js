var Button, Checkbox, CollapsibleSection, FormGroup, H, Icon, NavPills, NumberInput, PropTypes, R, Radio, React, Select, TextInput, Toggle, _, classnames,
...
exports.NumberInput = NumberInput = (function(superClass) {
  ...
  function NumberInput(props) {
    this.getNumericValue = bind(this.getNumericValue, this);
  ...
  NumberInput.prototype.getNumericValue = function() {
    var val;
...
exports.Toggle = Toggle = (function(superClass) {
  ...
  Toggle.prototype.renderOption = function(option, index) {
    ...
    return H.button(props, option.label);
  };
