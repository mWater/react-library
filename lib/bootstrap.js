...
exports.Toggle = exports.NavPills = exports.CollapsibleSection = exports.NumberInput = exports.TextInput = exports.Select = exports.Radio = exports.Checkbox = exports.FormGroup = exports.Icon = exports.Button = exports.Spinner = void 0;
...
class Button extends react_1.default.Component {
    render() {
        return R("button", {
            type: "button",
            className: classnames_1.default("btn", `btn-${this.props.type}`, { active: this.props.active }, { [`btn-${this.props.size}`]: this.props.size != null }),
...
class FormGroup extends react_1.default.Component {
    render() {
        ...
        return R("div", { className: classnames_1.default(classes) }, R("label", { key: "label" }, this.props.labelMuted ? R("span", { className: "text-muted" }, this.props.label) : this.props.label, this.props.hint
...
class Checkbox extends react_1.default.Component {
    ...
    render() {
        if (this.props.inline) {
            return R("label", { className: "checkbox-inline" }, R("input", {
                type: "checkbox",
            ...
            return R("div", { className: "checkbox" }, R("label", null, R("input", {
                type: "checkbox",
                checked: this.props.value || false,
                onChange: this.props.onChange ? this.handleChange : undefined
            }), this.props.children));
...
class Radio extends react_1.default.Component {
    render() {
        if (this.props.inline) {
            return R("label", { className: "radio-inline" }, R("input", {
                type: "radio",
            ...
            return R("div", { className: "radio" }, R("label", null, R("input", {
                type: "radio",
                checked: this.props.value === this.props.radioValue,
                onChange() { },
                onClick: this.props.onChange ? (ev) => this.props.onChange(this.props.radioValue) : undefined
...
class Select extends react_1.default.Component {
    ...
    render() {
        ...
        return R("select", {
            ...
            className: classnames_1.default("form-control", { "input-sm": this.props.size === "sm" }, { "input-lg": this.props.size === "lg" }),
...
class CollapsibleSection extends react_1.default.Component {
    ...
    render() {
        return R("div", { className: "form-group" }, R("label", { key: "label", onClick: this.handleToggle, style: { cursor: "pointer" } }, this.state.open
...
class NavPills extends react_1.default.Component {
    render() {
        return R("ul", { className: "nav nav-pills" }, lodash_1.default.map(this.props.pills, (pill) => {
            return R("li", { key: pill.id, className: pill.id === this.props.activePill ? "active" : "" }, R("a", { href: pill.href, onClick: () => { var _a, _b; return (_b = (_a = this.props).onPillClick) === null || _b === void 0 ? void 0 : _b.call(_a, pill.id); } }, pill.label));
        }));
    }
}
...
class Toggle extends react_1.default.Component {
    constructor() {
        ...
        this.renderOption = (option, index) => {
            ...
            const btnClasses = classnames_1.default("btn", {
    ...
    render() {
        return R("div", { className: `btn-group ${this.props.size ? `btn-group-${this.props.size}` : ""}` }, lodash_1.default.map(this.props.options, this.renderOption));
    }
}
