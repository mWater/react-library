    ...
    (0, _createClass2["default"])(ActionCancelModalComponent, [{
      ...
      value: function render() {
        return React.createElement(ModalPopupComponent, {
          ...
          footer: [this.props.onAction ? R('button', {
            key: "action",
            type: "button",
          ...
          }), "\xA0"] : void 0, this.props.actionLabel || "Save") : void 0, R('button', {
            key: "cancel",
            type: "button",
            onClick: this.props.onCancel,
            className: "btn btn-default"
          }, this.props.cancelLabel || (this.props.onAction ? "Cancel" : "Close")), this.props.onDelete ? R('button', {
            key: "delete",
            type: "button",
            style: {
              "float": "left"
