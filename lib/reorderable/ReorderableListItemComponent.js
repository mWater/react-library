var DragSource, DropTarget, H, R, React, ReactDOM, ReorderableListItemComponent, _, collectSource, collectTarget, dragOrHover, itemSource, itemTarget,
...
dragOrHover = function(props, monitor, component, isDrop) {
...
itemTarget = {
  drop: function(props, monitor, component) {
    return dragOrHover(props, monitor, component, true);
  },
  hover: function(props, monitor, component) {
    return dragOrHover(props, monitor, component, false);
  },
