...
function DayWeekScale(props) {
    ...
    return react_1.default.createElement("g", null, segs.map(function (seg, i) {
        ...
        var right = props.dateToPx(seg[1]);
        return react_1.default.createElement("g", { key: i },
            react_1.default.createElement("line", { key: "left", x1: left, y1: 22, x2: left, y2: props.height, stroke: "#F0F0F0", strokeDasharray: 2, strokeWidth: 1 }),
            react_1.default.createElement("line", { key: "right", x1: right, y1: 22, x2: right, y2: props.height, stroke: "#F0F0F0", strokeDasharray: 2, strokeWidth: 1 }),
