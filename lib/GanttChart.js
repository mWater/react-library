...
function GanttChart(props) {
    ...
    var renderLabel = function (row, index) {
        ...
        return react_1.default.createElement("div", { key: index, className: "gantt-label", style: __assign(__assign({}, labelStyle), { paddingLeft: row.level * 10, position: "relative", paddingRight: 25 }) },
            ...
            showMenu ?
                react_1.default.createElement("div", { style: { position: "absolute", right: 5, top: 1 } },
    ...
    return react_1.default.createElement("div", { style: { position: "relative" }, onMouseMove: handleMouseMove, onMouseOut: handleMouseOut, ref: containerRef },
            ...
            react_1.default.createElement("div", { key: "left", style: { paddingLeft: 5, paddingTop: headerHeight, marginBottom: scrollBarHeight } },
                ...
                props.onAddRow ?
                    react_1.default.createElement("div", { key: "add" },
                        react_1.default.createElement("a", { style: { fontSize: 12, cursor: "pointer" }, onClick: props.onAddRow },
...
function GanttBarArea(props) {
    ...
    var renderBar = function (row, index) {
        ...
        if (row.startDate && row.endDate && row.startDate != row.endDate) {
            ...
            return react_1.default.createElement("div", { key: index, onClick: function () { if (props.onRowClick) {
                    props.onRowClick(index);
                } }, style: __assign(__assign({}, barStyle), { top: headerHeight + 5 + rowHeight * index, left: dateToPx(rowStartDate), width: dateToPx(rowEndDate) - dateToPx(rowStartDate), backgroundColor: row.color }) });
        }
