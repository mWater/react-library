...
function GanttChart(props) {
    ...
    var renderLabel = function (row, index) {
        ...
        var showMenu = canMoveLeft || canMoveRight || canMoveUp || canMoveDown || props.onInsertRowBelow != null || props.onInsertRowAbove != null || props.onInsertChildRow != null;
                ...
                react_1.default.createElement("div", { className: "menu", style: { position: "absolute", right: 5, top: 1 } },
                    ...
                    react_1.default.createElement("ul", { className: "dropdown-menu" },
                        ...
                        props.onInsertChildRow != null ?
                            react_1.default.createElement("li", null,
                                react_1.default.createElement("a", { onClick: function () { return props.onInsertChildRow(index); } },
                                    react_1.default.createElement("i", { className: "fa fa-plus" }),
                                    " ",
                                    props.T("Add Child Row")))
                            : null))
                : null);
    };
...
function GanttBarArea(props) {
    ...
    var scrollLeftBy = react_1.useRef(0);
    ...
    var handleWheel = function (ev) {
        ...
        var x = ev.clientX - containerRef.current.getBoundingClientRect().left + containerRef.current.scrollLeft;
        // Determine offset needed to keep mouse position in same place
        var diffX = (x / scale * newScale) - x;
    ...
    var renderBar = function (row, index) {
        ...
        // Diamonds for single dates
            ...
            var x = dateToPx(rowDate);
            var y = headerHeight + rowHeight * index + (rowHeight / 2);
            var size = 7;
    ...
    var todayPx = dateToPx(moment_1.default());
...
function YearScale(props) {
    ...
    return react_1.default.createElement("g", null, segs.map(function (seg, i) {
        var left = props.dateToPx(seg[0]);
        var right = props.dateToPx(seg[1]);
        return react_1.default.createElement("g", { key: i },
            react_1.default.createElement("line", { key: "left", x1: left, y1: 0, x2: left, y2: props.height, stroke: "#DDD" }),
            react_1.default.createElement("line", { key: "right", x1: right, y1: 0, x2: right, y2: props.height, stroke: "#DDD" }),
...
function MonthScale(props) {
    ...
    return react_1.default.createElement("g", null, segs.map(function (seg, i) {
        ...
        var right = props.dateToPx(seg[1]);
        return react_1.default.createElement("g", { key: i },
            react_1.default.createElement("line", { key: "left", x1: left, y1: 11, x2: left, y2: props.height, stroke: "#DDD" }),
            react_1.default.createElement("line", { key: "right", x1: right, y1: 11, x2: right, y2: props.height, stroke: "#DDD" }),
...
function DayWeekScale(props) {
    ...
    return react_1.default.createElement("g", null, segs.map(function (seg, i) {
        ...
        var right = props.dateToPx(seg[1]);
        return react_1.default.createElement("g", { key: i },
            react_1.default.createElement("line", { key: "left", x1: left, y1: 22, x2: left, y2: props.height, stroke: "#F0F0F0", strokeDasharray: 2 }),
            react_1.default.createElement("line", { key: "right", x1: right, y1: 22, x2: right, y2: props.height, stroke: "#F0F0F0", strokeDasharray: 2 }),
