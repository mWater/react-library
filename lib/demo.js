...
$(function() {
  var elem;
  elem = H.div(null, H.div({
    style: {
      height: 300,
      backgroundColor: "red"
    }
  }), R(FillDownwardComponent, null, H.div({
    style: {
      height: "100%",
