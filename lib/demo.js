...
function (_React$Component4) {
  (0, _inherits2["default"])(ModalWindowSample, _React$Component4);

  function ModalWindowSample(props) {
    var _this;

    (0, _classCallCheck2["default"])(this, ModalWindowSample);
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ModalWindowSample).call(this, props));
    _this.startEditing = _this.startEditing.bind((0, _assertThisInitialized2["default"])(_this));
    _this.finishEditing = _this.finishEditing.bind((0, _assertThisInitialized2["default"])(_this));
    _this.handleModalClose = _this.handleModalClose.bind((0, _assertThisInitialized2["default"])(_this));
    _this.state = {
      editing: false
    };
    return _this;
...
function (_React$Component5) {
  (0, _inherits2["default"])(ModalPopupSample, _React$Component5);

  function ModalPopupSample(props) {
    var _this2;

    (0, _classCallCheck2["default"])(this, ModalPopupSample);
    _this2 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ModalPopupSample).call(this, props));
...
function (_React$Component6) {
  (0, _inherits2["default"])(SortableSampleItem, _React$Component6);

  function SortableSampleItem(props) {
    var _this3;

    (0, _classCallCheck2["default"])(this, SortableSampleItem);
    _this3 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(SortableSampleItem).call(this, props));
    _this3.state = {
...
function (_React$Component7) {
  (0, _inherits2["default"])(SortableSample, _React$Component7);

  function SortableSample(props) {
    var _this4;

    (0, _classCallCheck2["default"])(this, SortableSample);
    _this4 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(SortableSample).call(this, props));
    _this4.renderItem = _this4.renderItem.bind((0, _assertThisInitialized2["default"])(_this4));
    _this4.updateOrder = _this4.updateOrder.bind((0, _assertThisInitialized2["default"])(_this4));
    _this4.addNewItem = _this4.addNewItem.bind((0, _assertThisInitialized2["default"])(_this4));
    _this4.state = {
      items: [{
        id: "red",
        children: [],
...
function (_React$Component8) {
  (0, _inherits2["default"])(BlocksComponent, _React$Component8);

  function BlocksComponent(props) {
    var _this5;

    (0, _classCallCheck2["default"])(this, BlocksComponent);
    _this5 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(BlocksComponent).call(this, props));
    _this5.state = {
      items: [{
        id: "1",
        type: "title"
...
function (_React$Component9) {
  (0, _inherits2["default"])(AutoSizeTestComponent, _React$Component9);
...
function (_React$Component10) {
  (0, _inherits2["default"])(ToggleTestComponent, _React$Component10);

  function ToggleTestComponent(props) {
    var _this7;

    (0, _classCallCheck2["default"])(this, ToggleTestComponent);
    _this7 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ToggleTestComponent).call(this, props));
    _this7.state = {
      action: 'keep'
    };
    return _this7;
...
function (_React$Component11) {
  (0, _inherits2["default"])(ReorderDemo, _React$Component11);

  function ReorderDemo(props) {
    var _this9;

    (0, _classCallCheck2["default"])(this, ReorderDemo);
    _this9 = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ReorderDemo).call(this, props));
    _this9.state = {
...
$(function () {
  ...
  elem = R(PopupHelpComponent, null, "This is a test!"); // elem = R 'div', null,
