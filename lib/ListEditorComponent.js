...
function ListEditorComponent(props) {
    ...
    const renderListItem = (item, index) => {
        ...
        return react_2.default.createElement("li", { className: "list-group-item", onClick: props.editLink ? undefined : handleClick, key: index },
            ...
            props.editLink && props.renderEditor != null ?
                react_2.default.createElement("a", { className: "btn btn-link btn-xs", onClick: handleClick, style: { float: "right", cursor: "pointer" } },
                    react_2.default.createElement("i", { className: "fa fa-pencil" }))
                : null,
    ...
    return react_2.default.createElement("div", null,
        adding && props.renderEditor != null ?
            react_2.default.createElement(ActionCancelModalComponent_1.default, { size: "large", actionLabel: "Add", onCancel: () => setAdding(undefined), onAction: () => {
        ...
        editing != null && props.renderEditor != null ?
            react_2.default.createElement(ActionCancelModalComponent_1.default, { size: "large", onCancel: () => setEditing(undefined), onAction: () => {
