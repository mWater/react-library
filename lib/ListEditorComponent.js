...
function ListEditorComponent(props) {
    ...
    const renderListItem = (item, index) => {
        ...
        return (react_2.default.createElement("li", { className: props.selectedIndex === index ? "list-group-item active" : "list-group-item", onClick: props.editLink ? undefined : handleClick, key: index },
            react_2.default.createElement("a", { onClick: handleDelete.bind(null, index), style: { float: "right", cursor: "pointer", color: props.selectedIndex === index ? "var(--bs-list-group-active-color)" : "var(--bs-primary)" } },
                react_2.default.createElement("i", { className: "fa fa-remove" })),
            props.editLink && props.renderEditor != null ? (react_2.default.createElement("a", { onClick: handleClick, style: { float: "right", cursor: "pointer", color: props.selectedIndex === index ? "var(--bs-list-group-active-color)" : "var(--bs-primary)", marginRight: 5 } },
