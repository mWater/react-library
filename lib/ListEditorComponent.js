...
function ListEditorComponent(props) {
    ...
    const renderListItem = (item, index) => {
        ...
        return (react_2.default.createElement("li", { className: "list-group-item", onClick: props.editLink ? undefined : handleClick, key: index },
            react_2.default.createElement("a", { className: "btn btn-link btn-sm", onClick: handleDelete.bind(null, index), style: { float: "right", cursor: "pointer" } },
                react_2.default.createElement("i", { className: "fa fa-remove" })),
            props.editLink && props.renderEditor != null ? (react_2.default.createElement("a", { className: "btn btn-link btn-sm", onClick: handleClick, style: { float: "right", cursor: "pointer" } },
