...
exports.GridComponent = function (props) {
    ...
    return react_1.default.createElement("div", { key: "pane", style: { width: props.width, height: props.height, overflow: "scroll", position: "relative" }, onScroll: handleScroll, onMouseUp: handleMouseUp, onMouseMove: handleMouseMove, ref: paneRef },
        react_1.default.createElement("div", { key: "inner", onKeyDown: handleKeyDown, tabIndex: 0, onMouseDown: handleMouseDown, onDoubleClick: handleDoubleClick, ref: innerRef, style: { width: totalWidth, height: totalHeight, cursor: colResizing != null ? "col-resize" : undefined, outline: "none" } },
            renderGrid(),
            renderCells(),
            renderSelection(),
            renderEditor(),
