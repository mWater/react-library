...
exports.GridComponent = function (props) {
     ...
     */
    var endEditing = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var handleMouseDown = function (ev) {
        ...
        var _a = xyToRowCol(ev.clientX - paneDiv.getBoundingClientRect().left + paneDiv.scrollLeft, ev.clientY - paneDiv.getBoundingClientRect().top + paneDiv.scrollTop), row = _a.row, col = _a.col;
    ...
    return react_1.default.createElement("div", { key: "pane", style: { width: props.width, height: props.height, overflow: "scroll", position: "relative" }, onScroll: handleScroll, ref: paneRef },
        react_1.default.createElement("div", { key: "inner", onKeyDown: handleKeyDown, tabIndex: 0, onMouseDown: handleMouseDown, onDoubleClick: handleDoubleClick, onMouseUp: handleMouseUp, onMouseMove: handleMouseMove, ref: innerRef, style: { width: totalWidth, height: totalHeight, cursor: colResizing != null ? "col-resize" : undefined, outline: "none" } },
            renderGrid(),
            renderCells(),
            renderSelection(),
            renderEditor(),
