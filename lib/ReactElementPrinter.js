...
class ReactElementPrinter {
    ...
    print(element, options) {
        ...
        const extraCss = jquery_1.default(`\
...
`);
        jquery_1.default("body").append(extraCss);
        // Add special region to body
        jquery_1.default("body").append('<div id="react_element_printer"></div>');
...
`);
        ...
        react_dom_1.default.render(element, jquery_1.default("#react_element_printer").get(0), () => {
            // Wait for element to render
            return lodash_1.default.delay(() => {
                // Call print
                window.print();
                // Unmount component
                react_dom_1.default.unmountComponentAtNode(jquery_1.default("#react_element_printer").get(0));
                // Remove rest of nodes
                jquery_1.default("#react_element_printer").remove();
                jquery_1.default("#react_element_printer_css").remove();
                return jquery_1.default("#react_element_printer_splash").remove();
            }, options.delay || 1000);
        });
    }
}
