    ...
    renderChildren() {
      ...
      for (let i = 0, end = (len * 2) + 1, asc = 0 <= end; asc ? i < end : i > end; asc ? i++ : i--) {
        ...
        // Add spacer if odd
          ...
          children.push(R(CrossComponent, {key: i, collapseTop: true, height: this.props.height, e: this.props.line, w: this.props.line, n: (isCenter ? this.props.line : undefined)}));
    ...
    render() {
      return R('div', {className: "flexBox", style: { flexFlow: "column nowrap", alignItems: "center" }},
        ...
        React.Children.count(this.props.children) > 0 ?
          R(CrossComponent, {collapseTop: true, height: this.props.height, s: this.props.line}) : undefined,
          // Put children
